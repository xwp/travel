...
<div id="crumb" class="py2 pl2 pr2 border-bottom travel-border-gray">
	<span class="bold py1 pl1 pr1"><a class="travel-link" href="<?php echo esc_html( home_url() ); ?>"><?php esc_html_e( 'Home' ); ?></a></span>
	<span class="travel-results-result-subtext">></span>
	<span class="bold py1 pl1 pr1"><?php echo esc_html( $term->name ); ?></span>
	<span class="travel-results-result-subtext">></span>
