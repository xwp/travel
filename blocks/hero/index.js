...
export default registerBlockType(
	'amp-travel/hero',
	{
				...
				<section className='travel-hero relative'>
					<div className='travel-hero-content max-width-3 mx-auto absolute top-0 left-0 right-0 flex self-end items-center'>
						<div className='travel-hero-content-inner relative px1 md-px2 flex-auto self-end'>
							<header>
								<h1 className='travel-hero-heading mb2 line-height-1'>Adventures<br className='md-hide lg-hide'/> made&nbsp;easy</h1>
								<h2 className='travel-hero-subheading line-height-2 bold xs-hide sm-hide'>Find and book activities, tours, and experiences.</h2>
							</header>
							<div className='travel-hero-search'>
								<label className='travel-input-icon travel-shadow flex col-12 relative rounded'>
									<input className='travel-input travel-input-big travel-input-clear border block col-12 rounded' list='locations' type='text' name='query' placeholder='Where would you like to go?' />
								...
								<div className='travel-hero-search-dates flex my2 justify-around'>
									<label className='travel-date-input relative bold flex-auto'  >
										...
										<svg className='travel-icon' viewBox='0 0 100 100'><path fill='currentColor' d='M7.93 79.476h84.32v8.876H7.93v-8.876zm86.848-41.538c-.932-3.55-4.615-5.68-8.165-4.704l-23.566 6.302L32.427 11l-8.566 2.263 18.374 31.82-22.056 5.902-8.743-6.834L5 45.883l8.077 14.023 3.417 5.903 7.1-1.91 23.566-6.3 19.305-5.148 23.565-6.302c3.594-1.02 5.68-4.66 4.748-8.21z'></path></svg>            <div className='travel-date-input-label'>
										Departure
									</div>
									</label>
									<label className='travel-date-input relative bold flex-auto' >
		...
		save() {
			...
			const ampSrcProp = {
				'data-amp-bind-src': "'/api/places?types=(regions)&amp;types=(cities)&amp;input=' + fields_query_live" // eslint-disable-line
			};

			const departureClassNameProp = {
				'[class]': "'travel-date-input relative bold flex-auto' + (fields_departure ? ' travel-date-input-touched' : '')" // eslint-disable-line
			};
			const returnClassNameProp = {
				'[class]': "'travel-date-input relative bold flex-auto' + (fields_return ? ' travel-date-input-touched' : '')" // eslint-disable-line
			};
					...
					<div className='travel-hero-content max-width-3 mx-auto absolute top-0 left-0 right-0 flex self-end items-center'>
						<div className='travel-hero-content-inner relative px1 md-px2 flex-auto self-end'>
							...
							<div className='travel-hero-search'>
								...
								<amp-list layout='fixed-height' height="80px" src={travelGlobals.themeUrl + '/blocks/hero/demo-places.json'} {...ampSrcProp } aria-live='polite'>
