							...
							<div className='flex px1 md-px2 mxn1'>
									...
									<div className='travel-popular-tilt-right mb1'>
										<div className='relative travel-results-result'>
											<a className='travel-results-result-link block relative' href='#'>
												<img width='346' height='200' src={ travelGlobals.themeUrl + '/img/surf-day.jpg' } />
											</a>
								...
								<div className='m1 mt3 mb2'>
									<div className='travel-results-result relative mb1'>
										<div className='relative travel-results-result'>
											<a className='travel-results-result-link block relative' href='#'>
												<img width='346' height='200' src={ travelGlobals.themeUrl + '/img/discover-electronic-scene.jpg' } />
											</a>
								...
								<div className='m1 mt3 mb2'>
									<div className='travel-popular-tilt-left mb1'>
										<div className='relative travel-results-result'>
											<a className='travel-results-result-link block relative' href='#'>
												<img width='346' height='200' src={ travelGlobals.themeUrl + '/img/skateboard-around-city.jpg' } />
											</a>
											<div className='travel-results-result-like absolute top-0 right-0'>
												<div className='p1'>
							...
							<div className='flex px1 md-px2 mxn1'>
								<div className='m1 mt3 mb2'>
									<div className='travel-popular-tilt-right mb1'>
										<div className='relative travel-results-result'>
											<a className='travel-results-result-link block relative' href='#'>
												<amp-img class='block rounded' width='346' height='200' noloading='' src={ travelGlobals.themeUrl + '/img/surf-day.jpg' } srcset={ travelGlobals.themeUrl + '/img/surf-day@2x.jpg 2x, ' + travelGlobals.themeUrl + '/img/surf-day.jpg 1x' }></amp-img>
											</a>
											<div className='travel-results-result-like absolute top-0 right-0'>
												<div className='p1'>
													<label className='travel-like'>
								...
								<div className='m1 mt3 mb2'>
									<div className='travel-results-result relative mb1'>
										<div className='relative travel-results-result'>
											<a className='travel-results-result-link block relative' href='#'>
												<amp-img class='block rounded' width='346' height='200' noloading='' src={ travelGlobals.themeUrl + '/imgdiscover-electronic-scene.jpg' } srcset={ travelGlobals.themeUrl + '/img/discover-electronic-scene@2x.jpg 2x, ' + travelGlobals.themeUrl + '/img/discover-electronic-scene.jpg 1x' }></amp-img>
											</a>
											<div className='travel-results-result-flags absolute top-0 left-0'>
												<div className='p1'><span className='travel-pill bold'>NEW</span></div>
											</div>
								...
								<div className='m1 mt3 mb2'>
									<div className='travel-popular-tilt-left mb1'>
										<div className='relative travel-results-result'>
											<a className='travel-results-result-link block relative' href='#'>
												<amp-img class='block rounded' width='346' height='200' noloading='' src={ travelGlobals.themeUrl + '/img/skateboard-around-city.jpg' } srcset={ travelGlobals.themeUrl + '/img/skateboard-around-city@2x.jpg 2x, ' + travelGlobals.themeUrl + '/img/skateboard-around-city.jpg 1x' }></amp-img>
											</a>
											<div className='travel-results-result-like absolute top-0 right-0'>
												<div className='p1'>
													<label className='travel-like'>
